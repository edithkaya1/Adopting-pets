    ...
    foreach ($rows as $row) {
        ...
        $cards .= "<div>
               <div class='card mx-auto my-3'>
                   ...
                   <div class='card-body'>
                   <h5 class='card-title fw-bold text-center'>{$row['name']}</h5>
                   <p class='card-text fw-bold text-center'>Breed: {$row['breed']}</p>
                    <p class='card-text1 fw-bold text-center'>Gender: {$row['gender']}</p>
                     <p class='card-text2 fw-bold text-center'>Location: {$row['location']}</p>
...
<body>
    ...
    <div class="container-fluid bg-image">
        ...
        <h1 class="header2 text-center fw-bold my-2">List of available pets</h1>
