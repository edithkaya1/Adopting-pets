             ...
             <div class='card-header'>
              ...
              <div class='card-body bg-success-subtle'>
               ...
               <div style='text-align: center'>
                  ...
                  <a href='adopting.php?id=$row[id]' class='btn btn-outline-warning btn-lg text-center mx-4 my-3'>Adopting an animal</a> 
             </div>
             </div>
            </div>         
          </div>";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse p-3" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-link active" href="home.php">List of animals</a>
                </div>
            </div>
        </div>
    </nav>
